...
const ThreeDCarousel = () => {
  ...
  return (
    ...
    <section className="relative h-[500px] md:h-[800px] -mb-32 md:mb-0 w-screen left-1/2 -ml-[50vw] overflow-hidden flex flex-col items-center justify-center bg-black mb-[0px]">
