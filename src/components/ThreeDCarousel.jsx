...
const ThreeDCarousel = () => {
  ...
  return (
    ...
    <section className="relative h-[400px] md:h-[700px] -mt-20 -mb-40 md:-mb-20 w-screen left-1/2 -ml-[50vw] overflow-hidden flex flex-col items-center justify-center bg-black">
